 ...
 */
public record SquadListPacket(List<Entry> squads) {
    ...
    public static void handle(SquadListPacket msg, java.util.function.Supplier<NetworkEvent.Context> ctx) {
        ctx.get().setPacketHandled(true);
        DistExecutor.unsafeRunWhenOn(Dist.CLIENT, () -> () -> ClientPacketHandler.handleSquadList(msg));
    }
}
